...
(function(root, factory) {
	...
	Selectize.define('optgroup_columns', function(options) {
		...
		var equalizeSizes = function() {
			...
			/**
			 * Custom code added @Jeff McCoy, Jan 2014 for FTSS
			 */
			_.each($optgroups, function (opt, key) {

				opt.className =
					[
						'optgroup',
						'count-' + ($optgroups.length - 1),
						opt.dataset.group.toLowerCase().replace(/\s/g, '')
					].join(' ');
		...
		this.setup = (function() {
			...
			return function() {
				...
				this.$control.on('click', '.' + options.className, function(e) {
					...
					// Removed lock check @Jeff McCoy, Jan 2014 for FTSS
					//if (self.isLocked) return;
					...
					// Weird fix for placeholder text not refreshing @Jeff McCoy, Jan 2014 for clear
					self.blur();
				});
